...
class FCEUSavestate: public SaveState
{
...
class FCEUMovie: public Movie
{
    ...
    typedef FCEUSavestate<typename Movie::SaveState> Statetype;
    
public:
    bool Load(const std::vector<unsigned char>& data)
    {
        if(R32(data[0]) != R32(*"FCM\032")) return false;
